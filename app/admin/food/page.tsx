  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Yemekler</h1>
        <Link href="/admin/food/new" className="bg-gray-900 text-white px-4 py-2 rounded text-sm hover:bg-gray-700">+ Yeni Ekle</Link>
      </div>
            ...
            {items.map((item) => (
              <tr key={item._id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-right space-x-2">
                  <Link href={`/admin/food/${item._id}`} className="text-blue-600 hover:underline">Düzenle</Link>
